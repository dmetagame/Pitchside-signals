...
/**
 * Map a market label to a CoinGecko id when a price feed is available. X Cup
 * event markets usually fall back to deterministic demo resolution so the app
 * still closes the publish -> settle -> reputation loop end-to-end.
 */
