...
import { xLayerChain, signalBondAbi, signalBondAddress } from "./contract";
...
export async function submitResolution(
  ...
  if (!signalBondAddress) throw new Error("PitchSide Signals contract address is not configured.");
