 ...
 * `pitchside:followed` for easy migration if we ever back this with a wallet
 * preferences object.
 */

const STORAGE_KEY = "pitchside:followed";
const STORAGE_EVENT = "pitchside:followed-change";
