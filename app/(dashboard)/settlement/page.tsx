    ...
    <div className="mx-auto flex max-w-[1400px] flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-6">
        ...
        <InfoCard
          ...
          href={resolverAddress ? xLayerAddressUrl(resolverAddress) : undefined}
          mono
        />
        <InfoCard
          icon={<ShieldCheck className="size-4" strokeWidth={1.75} />}
          ...
          href={ownerAddress ? xLayerAddressUrl(ownerAddress) : undefined}
          mono
        />
        <InfoCard
          icon={<ShieldCheck className="size-4" strokeWidth={1.75} />}
          ...
          href={treasuryAddress ? xLayerAddressUrl(treasuryAddress) : undefined}
          mono
        />
        <InfoCard
          icon={<Gavel className="size-4" strokeWidth={1.75} />}
        ...
        <InfoCard
          ...
          href={lastOnchainTx ? xLayerTxUrl(lastOnchainTx) : undefined}
          mono
        />
      </div>
