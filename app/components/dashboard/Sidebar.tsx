      ...
      >
        <div className="flex items-center gap-3 px-2">
          <div className="flex size-9 items-center justify-center rounded-lg bg-accent overflow-hidden">
            <PitchSideMark size={36} />
          </div>
          <div className="flex flex-1 flex-col">
            <span className="text-[15px] font-semibold tracking-tight">PitchSide</span>
            <span className="text-[11px] uppercase tracking-wider text-faint">X Cup signals</span>
          </div>
          <button
            type="button"
            onClick={() => setMobileOpen(false)}
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="rounded-2xl border border-line-soft bg-panel-muted p-4">
          ...
          <div className="text-sm font-semibold text-text">
            {connected ? "X Layer stake" : "Connect Wallet"}
          </div>
