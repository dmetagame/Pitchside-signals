    ...
    <div className="fixed inset-0 z-50 flex justify-end" role="dialog" aria-modal>
      ...
      <aside className="relative flex h-full w-full max-w-[560px] flex-col border-l border-line bg-panel shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          <section className="mt-6">
            <SectionTitle title="X Layer Proof" />
            <div className="mt-3 divide-y divide-line-soft rounded-2xl border border-line-soft">
              {publishTxIndexed ? (
                <ProofLink
                  ...
                  href={xLayerTxUrl(selectedSignal.txHash)}
                />
              ) : (
              ...
              {selectedSignal.settlementTxHash && (
                <ProofLink
                  ...
                  href={xLayerTxUrl(selectedSignal.settlementTxHash)}
                />
              )}
              ...
              {signalBondAddress && (
                <ProofLink
                  label="PitchSide contract"
                  value={shortHash(signalBondAddress)}
                  href={xLayerAddressUrl(signalBondAddress)}
                />
              )}
              {usdcAddress && (
                <ProofLink
              ...
              {selectedSignal.publisher && (
                <ProofLink
                  ...
                  href={xLayerAddressUrl(selectedSignal.publisher)}
                />
              )}
...
function LifecycleLedger({
  ...
  const settlementHref = signal.settlementTxHash ? xLayerTxUrl(signal.settlementTxHash) : undefined;
  ...
  const rows: LifecycleRow[] = [
    {
      ...
      tone: "complete",
      href: publishTxIndexed ? xLayerTxUrl(signal.txHash) : undefined,
    ...
    },
    {
      ...
      body: settled
        ...
        : "Pending resolver transaction on X Layer.",
      meta: settled
